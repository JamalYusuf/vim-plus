...
//#endregion
  ...
  [kBgCmd.openSidePanel]: {}
  [kBgCmd.toggleTabGroup]: { title?: string; color?: "grey" | "blue" | "red" | string }
  [kBgCmd.collapseTabGroup]: { collapsed?: boolean }
  [kBgCmd.renameTabGroup]: { title?: string; color?: "grey" | "blue" | "red" | string }
  [kBgCmd.moveTabToGroup]: { title?: string }
  [kBgCmd.addToReadingList]: { title?: string }
  [kBgCmd.toggleBookmark]: { parentId?: string; folder?: string }
  [kBgCmd.cycleWindows]: { minimized?: boolean; last?: boolean }
  [kBgCmd.showLastDownload]: { open?: boolean; show?: boolean }
  /** Snap the current window to a screen edge; repeat same direction to shrink (see dockWindowStep). */
  [kBgCmd.dockWindow]: {
    direction?: "left" | "right" | "up" | "down" | "top" | "bottom" | "center" | "max" | "maximize"
    /** Override settings: percent of *previous* size kept on each repeat (25–90). */
    step?: number
    /** First dock fraction of the work area (0.25–0.75). Default 0.5. */
    first?: number
  }
...
interface BgCmdInfoMap {
  ...
  [kBgCmd.openSidePanel]: kCmdInfo.ActiveTab
  [kBgCmd.toggleTabGroup]: kCmdInfo.ActiveTab
  [kBgCmd.collapseTabGroup]: kCmdInfo.ActiveTab
  [kBgCmd.renameTabGroup]: kCmdInfo.ActiveTab
  [kBgCmd.moveTabToGroup]: kCmdInfo.ActiveTab
  [kBgCmd.addToReadingList]: kCmdInfo.ActiveTab
  [kBgCmd.toggleBookmark]: kCmdInfo.ActiveTab
}
...
interface CmdNameIds {
  ...
  "Vomnibar.activateWindows": kBgCmd.showVomnibar
  ...
  cycleWindows: kBgCmd.cycleWindows
  dockWindow: kBgCmd.dockWindow
  dockWindowLeft: kBgCmd.dockWindow
  dockWindowRight: kBgCmd.dockWindow
  dockWindowUp: kBgCmd.dockWindow
  dockWindowDown: kBgCmd.dockWindow
  dockWindowMax: kBgCmd.dockWindow
  ...
  enterPictureInPicture: kFgCmd.pictureInPicture
  ...
  moveTabToGroup: kBgCmd.moveTabToGroup
  ...
  collapseTabGroup: kBgCmd.collapseTabGroup
  ...
  openDownloads: kBgCmd.openUrl
  openExtensions: kBgCmd.openUrl
  openHistoryPage: kBgCmd.openUrl
  openSettings: kBgCmd.openUrl
  openShortcuts: kBgCmd.openUrl
  openSidePanel: kBgCmd.openSidePanel
  openUrl: kBgCmd.openUrl
  addToReadingList: kBgCmd.addToReadingList
  parentFrame: kBgCmd.parentFrame
  pictureInPicture: kFgCmd.pictureInPicture
  ...
  showHUD: kBgCmd.showHUD
  showLastDownload: kBgCmd.showLastDownload
  ...
  toggleTabGroup: kBgCmd.toggleTabGroup
  ...
  toggleBookmark: kBgCmd.toggleBookmark
  renameTabGroup: kBgCmd.renameTabGroup
...
type StandardShortcutNames = "createTab" | "goBack" | "goForward" | "previousTab"
    | "nextTab" | "reloadTab" | "openSidePanel" | "visitPreviousTab" | "toggleMuteTab" | "discardTab"
    | CNameLiterals.userCustomized
