...
import {
  ...
  openSidePanel, toggleTabGroup, collapseTabGroup, renameTabGroup, moveTabToGroup,
  addToReadingList, toggleBookmark, cycleWindows, showLastDownload, dockWindow
} from "./tab_commands"
...
set_cmdInfo_([
  ...
  /* kBgCmd.openSidePanel   */ Info.ActiveTab, Info.ActiveTab, Info.ActiveTab, Info.ActiveTab, Info.ActiveTab,
  /* kBgCmd.addToReadingList*/ Info.ActiveTab, Info.ActiveTab,
  /* kBgCmd.cycleWindows    */ Info.NoTab, Info.NoTab, Info.NoTab
] satisfies {
...
//#endregion
  ...
  /* kBgCmd.sendToExtension: */ (resolve): void | kBgCmd.sendToExtension => {
    ...
    try {
      browser_.runtime.sendMessage(targetID, get_cOptions<C.sendToExtension>().raw ? data : {
        handler: "message", from: "Vim+", count: cRepeat, keyCode: cKey, data
      }, (cb): void => {
  ...
  /* kBgCmd.openSidePanel: */ _AsBgC<BgCmdActiveTab<kBgCmd.openSidePanel>>(openSidePanel),
  /* kBgCmd.toggleTabGroup: */ _AsBgC<BgCmdActiveTab<kBgCmd.toggleTabGroup>>(toggleTabGroup),
  /* kBgCmd.collapseTabGroup: */ _AsBgC<BgCmdActiveTab<kBgCmd.collapseTabGroup>>(collapseTabGroup),
  /* kBgCmd.renameTabGroup: */ _AsBgC<BgCmdActiveTab<kBgCmd.renameTabGroup>>(renameTabGroup),
  /* kBgCmd.moveTabToGroup: */ _AsBgC<BgCmdActiveTab<kBgCmd.moveTabToGroup>>(moveTabToGroup),
  /* kBgCmd.addToReadingList: */ _AsBgC<BgCmdActiveTab<kBgCmd.addToReadingList>>(addToReadingList),
  /* kBgCmd.toggleBookmark: */ _AsBgC<BgCmdActiveTab<kBgCmd.toggleBookmark>>(toggleBookmark),
  /* kBgCmd.cycleWindows: */ _AsBgC<BgCmdNoTab<kBgCmd.cycleWindows>>(cycleWindows),
  /* kBgCmd.showLastDownload: */ _AsBgC<BgCmdNoTab<kBgCmd.showLastDownload>>(showLastDownload),
  /* kBgCmd.dockWindow: */ _AsBgC<BgCmdNoTab<kBgCmd.dockWindow>>(dockWindow)
])
