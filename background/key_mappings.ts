...
const defaultKeyMappings_: string =
  ...
  " gF "   +AsC_("mainFrame")           +" gS "     +AsC_("openSidePanel")   +" gT "     +AsC_("previousTab")         +
  " gU "   +AsC_("goToRoot")            +
  ...
  " yt "   +AsC_("duplicateTab")        +" yy "     +AsC_("copyCurrentUrl")  +" yY "     +AsC_("copyCurrentTitle")    +
  " yg "   +AsC_("toggleTabGroup")      +" yG "     +AsC_("collapseTabGroup")+" yr "     +AsC_("addToReadingList")    +
  " ym "   +AsC_("toggleBookmark")      +" yp "     +AsC_("enterPictureInPicture")+" <c-y> "+AsC_("scrollUp")         +
  " zH "   +AsC_("scrollToLeft")        +" zL "     +AsC_("scrollToRight")   +" zd "     +AsC_("discardTab")          +
  " gD "   +AsC_("openDownloads")       +" gH "     +AsC_("Vomnibar.activateHistory")+" gW "+AsC_("cycleWindows")     +
  " gA "   +AsC_("Vomnibar.activateWindows") +
  " <a-left> "  +AsC_("dockWindowLeft")  +" <a-right> "+AsC_("dockWindowRight") +
  " <a-up> "    +AsC_("dockWindowUp")    +" <a-down> " +AsC_("dockWindowDown")  +
  " <a-s-m> "   +AsC_("dockWindowMax")   +
  " co "   +AsC_("closeOtherTabs")      +" c> "     +AsC_("closeTabsOnRight")+" c< "     +AsC_("closeTabsOnLeft")     +
  " yl "   +AsC_("showLastDownload")    +" / "      +AsC_("enterFindMode")       +
...
export const availableCommands_: { readonly [key in kCName]: CommandsNS.Description } & SafeObject = {
  ...
  "Vomnibar.activateWindows": [ kBgCmd.showVomnibar, kCxt.bg, 1, { mode: "window" } ],
  ...
  moveTabToGroup: [ kBgCmd.moveTabToGroup, kCxt.bg, 0 ],
  ...
  renameTabGroup: [ kBgCmd.renameTabGroup, kCxt.bg, 1 ],
  ...
  openDownloads: [ kBgCmd.openUrl, kCxt.bg, 1, { url: "chrome://downloads" } ],
  openExtensions: [ kBgCmd.openUrl, kCxt.bg, 1, { url: "chrome://extensions" } ],
  openHistoryPage: [ kBgCmd.openUrl, kCxt.bg, 1, { url: "chrome://history" } ],
  openSettings: [ kBgCmd.openUrl, kCxt.bg, 1, { url: "chrome://settings" } ],
  openShortcuts: [ kBgCmd.openUrl, kCxt.bg, 1, { url: "chrome://extensions/shortcuts" } ],
  openSidePanel: [ kBgCmd.openSidePanel, kCxt.bg, 1 ],
  openUrl: [ kBgCmd.openUrl, kCxt.bg, 20 as 0 ],
  addToReadingList: [ kBgCmd.addToReadingList, kCxt.bg, 1 ],
  parentFrame: [ kBgCmd.parentFrame, kCxt.bg, 0 ],
  pictureInPicture: [ kFgCmd.pictureInPicture, kCxt.fg, 1 ],
  enterPictureInPicture: [ kFgCmd.pictureInPicture, kCxt.fg, 1 ],
  collapseTabGroup: [ kBgCmd.collapseTabGroup, kCxt.bg, 1 ],
  cycleWindows: [ kBgCmd.cycleWindows, kCxt.bg, 0 ],
  dockWindow: [ kBgCmd.dockWindow, kCxt.bg, 1 ],
  dockWindowLeft: [ kBgCmd.dockWindow, kCxt.bg, 1, { direction: "left" } ],
  dockWindowRight: [ kBgCmd.dockWindow, kCxt.bg, 1, { direction: "right" } ],
  dockWindowUp: [ kBgCmd.dockWindow, kCxt.bg, 1, { direction: "up" } ],
  dockWindowDown: [ kBgCmd.dockWindow, kCxt.bg, 1, { direction: "down" } ],
  dockWindowMax: [ kBgCmd.dockWindow, kCxt.bg, 1, { direction: "max" } ],
  showLastDownload: [ kBgCmd.showLastDownload, kCxt.bg, 1 ],
  ...
  toggleTabGroup: [ kBgCmd.toggleTabGroup, kCxt.bg, 1 ],
  ...
  toggleBookmark: [ kBgCmd.toggleBookmark, kCxt.bg, 1 ],
