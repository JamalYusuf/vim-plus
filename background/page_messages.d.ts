export declare const enum kPgReq {
   ...
   /** 34..42 */ sidePanelInit, keyBindingsList, recentTabs, readingListItems, runPageAction, commandCatalog,
      closedSessions, restoreSession,
  __mask = ""
}
...
export interface PgReq {
  ...
  [kPgReq.sidePanelInit]: [ void, {
    ver: string, status: Frames.ValidStatus, url: string, tabId: number, host: string, runnable: boolean
    /** true when host is in exclusion rules (Vim+ off for site) */
