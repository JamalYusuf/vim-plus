import {
  os_, CurCVer_, evalVimiumUrl_, historyCache_, IsEdg_, OnChrome, OnFirefox, searchEngines_, newTabUrl_f,
...
const RedirectedUrls_: SafeDict<string> = { __proto__: null as never,
  about: kWiki + "#about", changelog: kWiki + "#changelog", help: kWiki, home: kWiki,
  license: kWiki + "#license",
  option: kOpts, permissions: kWiki + "#permissions", policy: kWiki + "#privacy",
  action: kOpts, popup: kOpts, preference: kOpts, preferences: kOpts,
  privacy: kWiki + "#privacy", profile: kOpts, profiles: kOpts,
  readme: kWiki, release: kWiki + "#changelog", releases: kWiki + "#changelog",
