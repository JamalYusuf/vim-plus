...
Vim+ 1.0 feature inventory for users, reviewers, and marketing copy.
...
- Configurable match count, debounce, geometry (Options JSON)

## Command palette (`:`)

Discoverable short commands with categories:
...
- Bookmarks toggle
- Incognito window
- Browser default search (optional path)
- Omnibox keyword `v`
...
For implementation detail, see [developer.md](developer.md) and the in-extension wiki sections Architecture, Message flow, Settings pipeline, and Page enhance.
