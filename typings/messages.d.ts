...
declare const enum kBgCmd {
  ...
  addToReadingList, toggleBookmark,
  cycleWindows, showLastDownload, dockWindow,
  END, ENDS = "END",
}
...
declare const enum kFgCmd {
  ...
  framesGoBack, goToMark, pictureInPicture,
  END, ENDS = "END",
}
...
interface CmdOptions {
  ...
  [kFgCmd.pictureInPicture]: Req.FallbackOptions
  [kFgCmd.vomnibar]: {
    /* vomnibar */ v: string;
