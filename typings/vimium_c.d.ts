...
declare namespace CompletersNS {
  ...
  type ValidTypes = "bookm" | "domain" | "history" | "search" | "tab" | "window"
  /**
...
declare namespace VomnibarNS {
  ...
  const enum PixelData {
    ...
    /** Matches front/vomnibar.html `.item{height:48px}` / `.b{height:50px}` */
    Item = 48, LastItemDelta = 50 - Item,
...
declare const enum GlobalConsts {
  ...
  MarkAcrossJSWorlds = "__VimiumPlus_", // .length should be {@link #GlobalConsts.LengthOfMarkAcrossJSWorlds}
  LengthOfMarkAcrossJSWorlds = 13,
  ...
  ChromeWebStorePage = "https://jamal.dev",
  ...
  kLoadEvent = "VimiumPlus",
  kEvalNameInMV3 = "__VimiumPlus_eval__",
